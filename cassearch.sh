...
if $print_help ; then
    ...
    echo ;
    echo '-f, --function       searches and locates for functions only'
    ...
    echo '-s, --subroutine     searches and locates for subroutines only' ;
    exit 0 ;
fi
...
if ( ! $subroutine_search && ! $function_search ) || [[ $((num_lines_sub+num_lines_func)) == 0 ]] ; then
