...
dict_keywords = {
    ...
    # Kpoints.
    'KPOINT_LIST'             : { 'priority' : 5.1 },
    'KPOINTS_LIST'            : { 'priority' : 5.1 },
    'BS_KPOINT_LIST'          : { 'priority' : 5.1 },
    'BS_KPOINTS_LIST'         : { 'priority' : 5.1 },
    'PHONON_KPOINT_LIST'      : { 'priority' : 5.1 },
    'PHONON_KPOINTS_LIST'     : { 'priority' : 5.1 },
    'PHONON_FINE_KPOINT_LIST' : { 'priority' : 5.1 },
    'OPTICS_KPOINT_LIST'      : { 'priority' : 5.1 },
    'OPTICS_KPOINTS_LIST'     : { 'priority' : 5.1 },
    'MAGRES_KPOINT_LIST'      : { 'priority' : 5.1 },
    'SUPERCELL_KPOINT_LIST'   : { 'priority' : 5.1 },
    'SUPERCELL_KPOINTS_LIST'  : { 'priority' : 5.1 },
    'SPECTRAL_KPOINT_LIST'    : { 'priority' : 5.1 },
    'SPECTRAL_KPOINTS_LIST'   : { 'priority' : 5.1 },
