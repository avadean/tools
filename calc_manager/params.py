...
dict_keywords = {
    ...
    'SPECTRAL_TASK'             : { 'priority' : 0.3 , 'required' : False, 'default' : 'BANDSTRUCTURE'              , 'is_string' : True , 'is_bool' : False, 'is_float' : False, 'is_int' : False, 'has_unit' : False, 'allowed_values' : ['BANDSTRUCTURE', 'DOS', 'OPTICS', 'CORELOSS', 'ALL']},
